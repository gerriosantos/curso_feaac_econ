...
xaringanExtra::use_progress_bar(color = "#194435", location = "top", 
                                height = "10px")
```
...
url <- "https://gerriosantos.github.io/curso_feaac_econ/#1"
plot(qrcode::qr_code(url, ecl = 'M'), col = c('white', '#194435'))
